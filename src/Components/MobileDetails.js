...
const MobileDetails = () => {
    ...
    const handleImagesAndColor = (value) => {

        setImage(productData?.images[value]);
    ...
    return (
        <div>
            <Row className='m-3'>
                <Col md={3}>
                    <img src={image} style={{ width: "350px", height: "500x" }} alt={"mobile"} />
                ...
                <Col md={8} className='column-scroll pp-4 ms-5'>
                    ...
                    <h5>Colors: <br /><br />
                        {productData.color.map((color, index) => {
                            return (
                                <Button
                                    className='m-2 color-button'
                                    style={{ background: color }}
                                    onClick={() => handleImagesAndColor(index)}
                                >
                                </Button>
                            )
                        })}
